        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-auto text-left" style="padding: 34px;height: 72px;"><div class="group">   
...
<form action="Process.php" method="POST">
    ...
    <label>Email</label>
                ...
                <div class="row justify-content-center align-items-center" style="height: 72px;">
                    <div class="col-auto text-left" style="padding: 34px;"><div class="group">      
    ...
    <label></label>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-auto text-left" style="padding: 34px;height: 102px;"><div class="group">      
